...
INSERT INTO driver (user_id, rating, rating_count, available, current_location) VALUES
(2, 4.7, 10, true, ST_GeomFromText('POINT(77.1025 28.7041)', 4326)),
(3, 4.8, 10, true, ST_GeomFromText('POINT(77.2167 28.6667)', 4326)),
(4, 4.6, 10, true, ST_GeomFromText('POINT(77.2273 28.6353)', 4326)),
(5, 4.9, 10, true, ST_GeomFromText('POINT(77.2500 28.5500)', 4326)),
(6, 4.3, 10, true, ST_GeomFromText('POINT(77.2000 28.6200)', 4326)),
(7, 4.4, 10, true, ST_GeomFromText('POINT(77.2800 28.5900)', 4326)),
(8, 4.5, 10, true, ST_GeomFromText('POINT(77.2600 28.6800)', 4326)),
(9, 4.6, 10, true, ST_GeomFromText('POINT(77.2200 28.6400)', 4326)),
(10, 4.7, 10, true, ST_GeomFromText('POINT(77.2700 28.6700)', 4326)),
(11, 4.8, 10, true, ST_GeomFromText('POINT(77.2400 28.6100)', 4326)),
(12, 4.2, 10, true, ST_GeomFromText('POINT(77.2300 28.6600)', 4326)),
(13, 4.1, 10, true, ST_GeomFromText('POINT(77.1900 28.6000)', 4326)),
(14, 4.0, 10, true, ST_GeomFromText('POINT(77.1800 28.6300)', 4326)),
(15, 4.5, 10, true, ST_GeomFromText('POINT(77.1500 28.6500)', 4326)),
(16, 4.3, 10, true, ST_GeomFromText('POINT(77.1200 28.6700)', 4326)),
(17, 4.6, 10, true, ST_GeomFromText('POINT(77.1700 28.6800)', 4326)),
(18, 4.4, 10, true, ST_GeomFromText('POINT(77.1400 28.6900)', 4326)),
(19, 4.7, 10, true, ST_GeomFromText('POINT(77.1300 28.7000)', 4326)),
(20, 4.8, 10, true, ST_GeomFromText('POINT(77.1100 28.7100)', 4326)),
(21, 4.5, 10, true, ST_GeomFromText('POINT(77.2295 28.6129)', 4326)),
(22, 4.7, 10, true, ST_GeomFromText('POINT(77.2285 28.6159)', 4326)),
(23, 4.8, 10, true, ST_GeomFromText('POINT(77.2315 28.6119)', 4326)),
(24, 4.6, 10, true, ST_GeomFromText('POINT(77.2325 28.6169)', 4326)),
(25, 4.9, 10, true, ST_GeomFromText('POINT(77.2345 28.6179)', 4326)),
(26, 4.3, 10, true, ST_GeomFromText('POINT(77.2355 28.6199)', 4326)),
(27, 4.4, 10, true, ST_GeomFromText('POINT(77.2365 28.6219)', 4326)),
(28, 4.5, 10, true, ST_GeomFromText('POINT(77.2375 28.6239)', 4326)),
(29, 4.6, 10, true, ST_GeomFromText('POINT(77.2385 28.6259)', 4326)),
(30, 4.7, 10, true, ST_GeomFromText('POINT(77.2395 28.6279)', 4326)),
(31, 4.8, 10, true, ST_GeomFromText('POINT(77.2405 28.6299)', 4326)),
(32, 4.2, 10, true, ST_GeomFromText('POINT(77.2415 28.6319)', 4326)),
(33, 4.1, 10, true, ST_GeomFromText('POINT(77.2425 28.6339)', 4326)),
(34, 4.0, 10, true, ST_GeomFromText('POINT(77.2435 28.6359)', 4326)),
(35, 4.5, 10, true, ST_GeomFromText('POINT(77.2445 28.6379)', 4326)),
(36, 4.3, 10, true, ST_GeomFromText('POINT(77.2455 28.6399)', 4326)),
(37, 4.6, 10, true, ST_GeomFromText('POINT(77.2465 28.6419)', 4326)),
(38, 4.4, 10, true, ST_GeomFromText('POINT(77.2475 28.6439)', 4326)),
(39, 4.7, 10, true, ST_GeomFromText('POINT(77.2485 28.6459)', 4326)),
(40, 4.8, 10, true, ST_GeomFromText('POINT(77.2495 28.6479)', 4326));
